...
class MyPyPlotLoggerFormatter(logging.Formatter):
    """
...
def configure_logger(debug, logfile=None):
    ...
    """
    logger = logging.getLogger("MyPyPlot")
    ...
    formatter = MyPyPlotLoggerFormatter(color=lambda : getattr(sh.stream, 'isatty', None)) # pylint: disable=C0326
    ...
    if logfile is not None:
        ...
        fh.setFormatter(MyPyPlotLoggerFormatter())
...
def get_logger():
    ...
    return logging.getLogger("MyPyPlot")
